...
vi.mock('./components/ActivityForm', () => ({
    ActivityForm: () => _jsx("div", { "data-testid": "activity-form-mock", children: "ActivityForm" }),
}));
vi.mock('./components/RemindersScreen', () => ({
    RemindersScreen: () => _jsx("div", { "data-testid": "reminders-screen-mock", children: "RemindersScreen" }),
}));
// Mock sw/register
...
describe('App shell', () => {
    ...
    it('shows offline banner when navigator.onLine is false', () => {
        ...
        render(_jsx(App, {}));
        expect(screen.getByTestId('offline-banner')).toHaveTextContent('tidak ada koneksi — coba lagi nanti');
    });
