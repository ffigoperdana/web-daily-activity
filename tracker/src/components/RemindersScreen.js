  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('div', {
        className: 'card',
        children: [
          _jsx('h2', { className: 'section-title', children: 'Jam Pengingat' }),
          _jsxs('div', {
          ...
          _jsx('button', {
            ...
            children: saving ? 'Menyimpan…' : id.simpan_jam_pengingat,
          }),
        ],
      }),
      _jsxs('div', {
        className: 'card',
        children: [
          _jsx('h2', { className: 'section-title', children: 'Notifikasi Push' }),
          _jsx('button', {
            type: 'button',
            ...
            children: subscribing ? 'Mengaktifkan…' : id.aktifkan_pengingat,
          }),
          permissionDenied &&
            _jsx('div', {
              ...
              role: 'alert',
              children: id.izinkan_notifikasi,
            }),
          _jsx('button', {
            type: 'button',
            ...
            children: testing ? 'Mengirim…' : id.kirim_notifikasi_tes,
          }),
        ],
      }),
    ],
