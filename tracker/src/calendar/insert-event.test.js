...
describe('insertEvent', () => {
    ...
    it('does not retry on non-401 errors', async () => {
        ...
        vi.stubGlobal('fetch', vi
            .fn()
            .mockResolvedValue(jsonResponse(500, { error: { message: 'Internal error' } })));
        const result = await insertEvent(samplePayload, auth);
    ...
    it('sends correct Authorization header and JSON body', async () => {
        ...
        expect(fetch).toHaveBeenCalledWith('https://www.googleapis.com/calendar/v3/calendars/primary/events', {
            method: 'POST',
            headers: {
...
//# sourceMappingURL=insert-event.test.js.map